...
- Send <span style="color:green">**(1, 0, (as - ADDR_SPACE_OFFSET) \* 2^L, node\*label, hash_initial)**</span>
- Receive <span style="color:green">**(-1, 0, (as - ADDR_SPACE_OFFSET) \* 2^L, node_label, hash_final)**</span>
