...
- `--mode <MODE>`
  ...
  **Description**: Execution mode, one of `pure`, `meter`, and `segment`. For more information see (Distributed Proving Architecture)[/specs/architecture/distributed-proving.mdx#execution]
