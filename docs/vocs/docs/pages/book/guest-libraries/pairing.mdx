...
Additionally, we'll need to initialize our moduli and `Fp2` struct via the following macros. For a more in-depth description of these macros, please see [Algebra (Modular Arithmetic)
](/book/acceleration-using-extensions/algebra).
