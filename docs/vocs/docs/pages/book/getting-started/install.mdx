...
```bash
cargo +1.90 install --locked --git https://github.com/openvm-org/openvm.git --tag v1.5.0 cargo-openvm
```
...
```bash
git clone --branch v1.5.0 --single-branch https://github.com/openvm-org/openvm.git
cd openvm
...
```bash
cargo +1.90 install --locked --git https://github.com/openvm-org/openvm.git --tag v1.5.0 --features cuda cargo-openvm
```
...
:::code-group
```bash [Without GPU]
cargo +nightly-2025-08-19 install --locked --git https://github.com/openvm-org/openvm.git --tag v1.5.0 --features tco cargo-openvm
```
```bash [Nvidia GPU]
cargo +nightly-2025-08-19 install --locked --git https://github.com/openvm-org/openvm.git --tag v1.5.0 --features tco,cuda cargo-openvm
```
:::
...
:::code-group
```bash [Without GPU]
cargo +1.90 install --locked --git https://github.com/openvm-org/openvm.git --tag v1.5.0 --features aot cargo-openvm
```
```bash [Nvidia GPU]
cargo +1.90 install --locked --git https://github.com/openvm-org/openvm.git --tag v1.5.0 --features aot,cuda cargo-openvm
```
:::
