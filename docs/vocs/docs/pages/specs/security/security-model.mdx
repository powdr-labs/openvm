...
OpenVM targets 100 bits of provable security, achieved via a FRI-based backend for STARK 
...
* **FRI parameters**: `log_blowup`, `num_queries`, `query_proof_of_work_bits`, and `commit_proof_of_work_bits` to control the soundness of the FRI
...
| Proof | Type | Security Bits | `log_blowup` | `num_queries` | `query_proof_of_work_bits` | `commit_proof_of_work_bits` | `max_interaction_count` | `log_max_message_length` | `log_up_pow_bits` | `deep_pow_bits` |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `app` | STARK | 100 | 1 | 193 | 20 | 20 | `15 * 2^27 + 1` | 7 | 18 | 5 |
| `leaf` | STARK | 100 | 1 | 193 | 20 | 20 | `15 * 2^27 + 1` | 7 | 18 | 5 |
| `internal` | STARK | 100 | 2 | 118 | 20 | 16 | `15 * 2^27 + 1` | 7 | 18 | 5 |
| `root` | STARK | 100 | 3 | 97 | 20 | 16 | `15 * 2^27 + 1` | 7 | 18 | 5 |
